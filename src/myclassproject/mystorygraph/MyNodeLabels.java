...
public enum MyNodeLabels{
	// Added by Tri Huynh
	root, BeginningScene, BeginningScene1, BeginningScene2, AcceptToGo, AcceptToGo1, Consequence, RunAway, RunAway1, DelphineTalk, MagicForest, DelphineStudent, LearnLightMagic, LearnHealingMagic, 
