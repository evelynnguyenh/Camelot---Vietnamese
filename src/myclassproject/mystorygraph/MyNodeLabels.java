...
public enum MyNodeLabels{
	// Added by Tri Huynh
	root, BeginningScene, BeginningScene1, BeginningScene2, AcceptToGo, Consequence, RunAway, DelphineTalk, MagicForest, DelphineStudent, LearnLightMagic, LearnHealingMagic, 
