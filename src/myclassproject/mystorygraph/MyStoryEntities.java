...
public final class MyStoryEntities {
	...
	public static final Characters noble1 = new Characters("Minor Noble", BodyTypes.D, Clothing.Noble, HairStyle.Long, Colors.Black, 6);
	public static final Characters noble2 = new Characters("Minor Noble", BodyTypes.E, Clothing.Noble, HairStyle.Long, Colors.Black, 4);
	public static final Characters noble3 = new Characters("Minor Noble", BodyTypes.F, Clothing.Noble, HairStyle.Spiky, Colors.Black, 3);
	public static final Characters noble4 = new Characters("Minor Noble", BodyTypes.G, Clothing.Noble, HairStyle.Spiky, Colors.Black, 7);
	public static final Characters noble5 = new Characters("Minor Noble", BodyTypes.H, Clothing.Noble, HairStyle.Short, Colors.Black, 3);
